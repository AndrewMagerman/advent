...
def next_position(pos: Tuple, direction: str) -> Tuple:
    x = pos[0]
    y = pos[1]
    return k[direction](x, y)


initial = (0, 0,)


def trajectory(value: str, initial_position: Tuple = (0, 0,)) -> Set[Tuple]:
    where_i_have_been = list()
    where_i_have_been.append(initial_position)
...
if __name__ == '__main__':
    # a = (0,0,)
    # print(next_position(a, 'R'))
    # b = next_position(a, 'R')
    # print(b)
    # c = next_position(b, 'R')
    # print(c)
    # print(trajectory(test_wire_1))
    #
    # print(trajectory(test_wire_1) & trajectory(test_wire_2))
    print(manhattan_distance_closest_intersection(test_wire_1, test_wire_2))

    print(manhattan_distance_closest_intersection("R75,D30,R83,U83,L12,D49,R71,U7,L72",
